...
class YcCardViewEclairMr1 implements YcCardViewImpl {
    ...
    public void initStatic() {
        YcRoundRectDrawableWithShadow.sRoundRectHelper = (canvas, bounds, cornerRadius, paint) -> {
    ...
    @Override
    public void setShadowColor(YcCardViewDelegate cardView, int start, int end) {
        getShadowBackground(cardView).setShadowColor(start, end);
    }
