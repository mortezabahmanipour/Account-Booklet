...
//        } else
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.YcCardView, defStyleAttr, R.style.YcCardView);
        int backgroundColor;
        if (a.hasValue(R.styleable.YcCardView_ycCardBackgroundColor)) {
            ...
            backgroundColor = hsv[2] > 0.5f ? 0xFF424242 : 0xFFFFFFFF;
        }
        ...
        float maxElevation = a.getDimension(R.styleable.YcCardView_ycCardMaxElevation, AndroidUtilities.dp(500));
        ...
        mContentPadding.left = a.getDimensionPixelSize(R.styleable.YcCardView_ycContentPaddingLeft, defaultPadding);
        mContentPadding.top = a.getDimensionPixelSize(R.styleable.YcCardView_ycContentPaddingTop, defaultPadding);
        mContentPadding.right = a.getDimensionPixelSize(R.styleable.YcCardView_ycContentPaddingRight, defaultPadding);
        mContentPadding.bottom = a.getDimensionPixelSize(R.styleable.YcCardView_ycContentPaddingBottom, defaultPadding);
        ...
        IMPL.initialize(mCardViewDelegate, context, backgroundColor, radius, elevation, maxElevation, startShadowColor, endShadowColor);
    }
    ...
    public void setCardElevation(float elevation) {
        IMPL.setMaxElevation(mCardViewDelegate, elevation);
        IMPL.setElevation(mCardViewDelegate, elevation);
    }

    public void setCardShadowColor(int start, int end) {
        IMPL.setShadowColor(mCardViewDelegate, start, end);
    }
    ...
    private final YcCardViewDelegate mCardViewDelegate = new YcCardViewDelegate() {
        ...
        public void setCardBackground(Drawable drawable) {
            ...
            setBackgroundDrawable(mCardBackground);
        }
