...
public class YcRoundRectDrawableWithShadow extends Drawable {
    ...
    * */
    ...
    public YcRoundRectDrawableWithShadow(Resources resources, int backgroundColor, float radius,
        ...
        mInsetShadow = AndroidUtilities.dp(1);
...
//              + (1 - COS_45) * cornerRadius
    ...
    void setShadowColor(int start, int end) {
