...
public class CardsRow extends FrameLayout implements View.OnClickListener {
  ...
  private CardsModel card;
  private int indexView;

  @SuppressLint("SetTextI18n")
  public CardsRow setModel(CardsModel card) {
    this.card = card;
    if (card == null) {
      return this;
    }
  ...
  public CardsRow(@NonNull Context context) {
    super(context);
    ...
    addView(tvCardHolderNameName, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, AndroidUtilities.dp(40), 5, AndroidUtilities.dp(10), AndroidUtilities.dp(0), AndroidUtilities.dp(10), AndroidUtilities.dp(0)));
    ...
    addView(tvCardHolderName, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, AndroidUtilities.dp(40), 3, AndroidUtilities.dp(10), AndroidUtilities.dp(0), AndroidUtilities.dp(10), AndroidUtilities.dp(0)));
    ...
    addView(tvCardNumberName, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, AndroidUtilities.dp(40), 5, AndroidUtilities.dp(10), AndroidUtilities.dp(40), AndroidUtilities.dp(10), AndroidUtilities.dp(0)));
    ...
    tvCardNumber.setDrawableSize(AndroidUtilities.dp(17));
    tvCardNumber.setCompoundDrawables(Theme.content_copy_account_drawable, null, null, null);
    tvCardNumber.setCompoundDrawablePadding(AndroidUtilities.dp(5));
    tvCardNumber.setOnClickListener(this);
    addView(tvCardNumber, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, AndroidUtilities.dp(40), 3, AndroidUtilities.dp(10), AndroidUtilities.dp(40), AndroidUtilities.dp(10), AndroidUtilities.dp(0)));
    ...
    addView(tvAccountNumberName, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, AndroidUtilities.dp(40), 5, AndroidUtilities.dp(10), AndroidUtilities.dp(80), AndroidUtilities.dp(10), AndroidUtilities.dp(0)));
    ...
    tvAccountNumber.setDrawableSize(AndroidUtilities.dp(17));
    tvAccountNumber.setCompoundDrawables(Theme.content_copy_account_drawable, null, null, null);
    tvAccountNumber.setCompoundDrawablePadding(AndroidUtilities.dp(5));
    tvAccountNumber.setOnClickListener(this);
    addView(tvAccountNumber, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, AndroidUtilities.dp(40), 3, AndroidUtilities.dp(10), AndroidUtilities.dp(80), AndroidUtilities.dp(10), AndroidUtilities.dp(0)));
    ...
    tvShabaNumber.setDrawableSize(AndroidUtilities.dp(17));
    tvShabaNumber.setCompoundDrawables(Theme.content_copy_account_drawable, null, null, null);
    tvShabaNumber.setCompoundDrawablePadding(AndroidUtilities.dp(5));
    tvShabaNumber.setOnClickListener(this);
    addView(tvShabaNumber, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, AndroidUtilities.dp(40), AndroidUtilities.dp(10), AndroidUtilities.dp(0), AndroidUtilities.dp(10), AndroidUtilities.dp(0)));
    ...
    addView(tvBankName, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, AndroidUtilities.dp(40), AndroidUtilities.dp(10), AndroidUtilities.dp(0), AndroidUtilities.dp(10), AndroidUtilities.dp(0)));

    shadow1 = new View(context);
    shadow1.setBackgroundColor(shadowColor);
    addView(shadow1, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, AndroidUtilities.dp(1), AndroidUtilities.dp(10), AndroidUtilities.dp(0), AndroidUtilities.dp(10), AndroidUtilities.dp(0)));

    shadow2 = new View(context);
    shadow2.setBackgroundColor(shadowColor);
    addView(shadow2, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, AndroidUtilities.dp(1), AndroidUtilities.dp(10), AndroidUtilities.dp(0), AndroidUtilities.dp(10), AndroidUtilities.dp(0)));

    shadow3 = new View(context);
    shadow3.setBackgroundColor(shadowColor);
    addView(shadow3, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, AndroidUtilities.dp(1), AndroidUtilities.dp(10), AndroidUtilities.dp(0), AndroidUtilities.dp(10), AndroidUtilities.dp(0)));

    shadow4 = new View(context);
    shadow4.setBackgroundColor(shadowColor);
    addView(shadow4, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, AndroidUtilities.dp(1), AndroidUtilities.dp(10), AndroidUtilities.dp(0), AndroidUtilities.dp(10), AndroidUtilities.dp(0)));
  }
  ...
  public void onClick(View v) {
    ...
    if (v.equals(tvCardNumber)) {
      AndroidUtilities.addToClipboard(card.cardNumber);
      AndroidUtilities.toast(getContext(), "شماره کارت کپی شد");
    } else if (v.equals(tvAccountNumber)) {
      AndroidUtilities.addToClipboard(card.accountNumber);
      AndroidUtilities.toast(getContext(), "شماره حساب کپی شد");
    } else if (v.equals(tvShabaNumber)) {
      AndroidUtilities.addToClipboard(card.shabaNumber);
      AndroidUtilities.toast(getContext(), "شماره شبا کپی شد");
    }
  }
}
